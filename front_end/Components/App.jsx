...
export default class App extends React.Component {
  ...
  render() {
    ...
    const badgeStyle = {
      ...
      margins: '25px 25px 25px 25px'
    };

    const svgPadding = {
      padding: '10px 10px 10px 10px',
      margins: '35px 35px 10px 35px'
    };
    ...
    return (
      <div style={background}>
        <Navbar bg="dark" variant="dark" expand="lg">
          <Navbar.Brand href="#home">Justin Robert O'Hara</Navbar.Brand>
          <Navbar.Toggle aria-controls="basic-navbar-nav" />
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="mr-auto">
              <Nav.Link href="mailto:justinrobertohara@gmail.com">
                ✉ Email
              </Nav.Link>
              <Nav.Link href="https://www.linkedin.com/in/justinrobertohara/">
                LinkedIn
              </Nav.Link>
              <Nav.Link href="https://github.com/justinrobertohara">
                Github
              </Nav.Link>
            </Nav>
          </Navbar.Collapse>
        ...
        <Jumbotron style={{ backgroundColor: 'rgba(0, 0, 0, 0)' }}>
          ...
          <p>
            ...
            and my passion for software engineering stems from my curiosity and
            desire about how different technologies work together to solve
            everyday problems. My prior experience with React, Node, Express,
            and PostgresSQL/MongoDM in a team-based environment provides me with
            the knowledge I need to bring ideas to life. I enjoy learning new
            technologies and the underlying principles that tie them all
            together.{' '}
          </p>
        </Jumbotron>

        <Jumbotron style={{ backgroundColor: 'rgba(0, 0, 0, 0)' }}>
          <h1 style={{ padding: '0px 0px 40px 0px' }}>Expertise</h1>
          <CardGroup>
            <Card
              style={{
                backgroundColor: 'rgba(0, 0, 0, 0)',
            ...
            >
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Node, MySql, MongoDB, Express, PostgresSQL
                </Card.Text>
              </Card.Body>
            </Card>
            <Card
            ...
            >
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Git, Amazon Webservices, EC2/Elastic Bean Stalk, Github,
                  Webpack, Jest/Enzyme, Loader.IO, New Relic, Mocha/Chai, Agile
        ...
        <Navbar bg="dark" variant="dark" expand="lg">
          <Navbar.Collapse className="justify-content-end">
            <Navbar.Text>Justin Robert O'Hara ©</Navbar.Text>
          </Navbar.Collapse>
        </Navbar>
      </div>
    );
